...
import { MdDashboard, MdGroup, MdPersonAdd, MdSettings } from "react-icons/md";
          ...
          <div className="w-full px-6 md:px-8 py-4">
            <div className="flex justify-end items-center gap-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-gray-900 rounded-full flex items-center justify-center text-white font-bold text-lg overflow-hidden border-2 border-gray-200">
                  {user?.avatar ? (
                    <img
