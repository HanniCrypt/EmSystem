      ...
      <div className="pt-20 pb-8 px-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-xl transition-colors shadow-sm flex items-center gap-2"
          >
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
            ...
            <div className="space-y-6">
              <div className="flex justify-center mb-6">
                <div className="w-32 h-32 rounded-2xl bg-gray-50 ring-4 ring-gray-200 flex items-center justify-center overflow-hidden">
                  {user?.avatar ? (
                    <img
                      src={`data:image/jpeg;base64,${user?.avatar}`}
                      alt="Avatar"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm text-gray-700 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  className="px-4 py-2.5 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-xl transition-colors"
                >
                  Save Changes
                </button>
              </div>
