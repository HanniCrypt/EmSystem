      ...
      <div className="pt-20 pb-8 px-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-purple-700 capitalize">
              {user?.role}
            </span>
          </div>
          <button
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      value={user?.dept_name || "Not Assigned"}
                      disabled
                      className="w-full px-4 py-2.5 text-sm text-gray-500 border border-gray-200 rounded-xl bg-gray-50 cursor-not-allowed"
                    />
                    <div className="absolute inset-y-0 right-0 flex items-center pr-3">
